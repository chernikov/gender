...
namespace GenerateData
{
    public class OrganizationGenerate
    {
        ...
        public static string[] NounMale = {"союз", "альянс", "университет", "институт"};
        public static string[] NounFemale = {"школа", "организация", "корпорация", "фирма", "структура", "администрация", "контора", "институция", "колония", "лига"};
        public static string[] NounMiddle = {"учреждение", "министерство", "завдение"};
        ...
        public static string GetRandomOne()
        {
            ...
            return char.ToUpper(mainWord[0]) + mainWord.Substring(1);
        }
    }
}
