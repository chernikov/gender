function IndexImage() {
    ...
    this.ajaxAccess = "/admin/Image/Access";
    this.ajaxAddAccess = "/admin/Image/AddAccess";
    this.ajaxRemoveAccess = "/admin/Image/RemoveAccess";

    this.ajaxRedirects = "/admin/Image/Redirects";
    this.ajaxAddRedirect = "/admin/Image/AddRedirect";
