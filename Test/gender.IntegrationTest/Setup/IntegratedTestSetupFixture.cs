...
using gender.UnitTest;

namespace gender.IntegrationTest
{
    [SetUpFixture]
    public class IntegrationTestSetupFixture : UnitTestSetupFixture
    {
        ...
        protected static string NameDb = "gender";
        ...
        protected override void InitRepository(StandardKernel kernel)
        {
            ...
            kernel.Bind<genderDbDataContext>().ToMethod(c =>  new genderDbDataContext(connectionString));
