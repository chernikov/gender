...
namespace gender.Tools
{
    ...
    public static class PreviewCreator
    {
        ...
        /// <returns></returns>
        public static bool CheckSize(MemoryStream memoryImage, Size previewSize)
        {
            Bitmap image = null;
            try
            {
        ...
        public static void CreateAndSavePreview(MemoryStream memoryImage, Size previewSize, string fileName, bool grayscale = false)
        {
        ...
        /// </summary>
        /// <param name="memoryImage">memoryStream with imae</param>
        /// <param name="maxSize">max size</param>
        /// <param name="fileName">filename to save</param>
        /// <param name="grayscale">grayscale</param>
        public static void CreateAndSaveImage(MemoryStream memoryImage, Size maxSize, string fileName, bool grayscale = false)
        {
            var image = new Bitmap(memoryImage);
            Bitmap newBitmap = null;
            try
        ...
        /// <param name="fileName">filename to  save</param>
        /// <param name="grayscale">grayscale</param>
        public static void CreateAndSaveAvatar(MemoryStream memoryImage, Size maxSize, string fileName, bool grayscale = false)
        {
            var image = new Bitmap(memoryImage);
            Bitmap newBitmap = null;
            try
